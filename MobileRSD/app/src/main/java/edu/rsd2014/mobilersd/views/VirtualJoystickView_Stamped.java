package edu.rsd2014.mobilersd.views;
 ...
 */
public class VirtualJoystickView_Stamped extends RelativeLayout implements Animation.AnimationListener,
    ...
    private Publisher<TwistStamped> publisher;
    private Publisher<std_msgs.Bool> deadman_publisher;
    /**
    ...
    private TwistStamped currentVelocityCommand;
    private Bool deadmanSignal;
    private String topicName;

    //Kasper edits
    private Twist twist;
    private Vector3Stamped v3s;
    private int seqNumber = 0;

    public VirtualJoystickView_Stamped(Context context) {
        super(context);
        initVirtualJoystick(context);
        topicName = "~cmd_vel";
    }

    public VirtualJoystickView_Stamped(Context context, AttributeSet attrs) {
        super(context, attrs);
        initVirtualJoystick(context);
        topicName = "~cmd_vel";
    }

    public VirtualJoystickView_Stamped(Context context, AttributeSet attrs, int defStyle) {
    ...
    private void initVirtualJoystick(Context context) {
        ...
        LayoutInflater.from(context).inflate(org.ros.android.android_honeycomb_mr2.R.layout.virtual_joystick, this, true);
        mainLayout = (RelativeLayout) findViewById(org.ros.android.android_honeycomb_mr2.R.id.virtual_joystick_layout);
        magnitudeText = (TextView) findViewById(org.ros.android.android_honeycomb_mr2.R.id.magnitude);
        intensity = (ImageView) findViewById(org.ros.android.android_honeycomb_mr2.R.id.intensity);
        thumbDivet = (ImageView) findViewById(org.ros.android.android_honeycomb_mr2.R.id.thumb_divet);
        orientationWidget = new ImageView[24];
        orientationWidget[0] = (ImageView) findViewById(org.ros.android.android_honeycomb_mr2.R.id.widget_0_degrees);
        orientationWidget[1] = (ImageView) findViewById(org.ros.android.android_honeycomb_mr2.R.id.widget_15_degrees);
        orientationWidget[2] = (ImageView) findViewById(org.ros.android.android_honeycomb_mr2.R.id.widget_30_degrees);
        orientationWidget[3] = (ImageView) findViewById(org.ros.android.android_honeycomb_mr2.R.id.widget_45_degrees);
        orientationWidget[4] = (ImageView) findViewById(org.ros.android.android_honeycomb_mr2.R.id.widget_60_degrees);
        orientationWidget[5] = (ImageView) findViewById(org.ros.android.android_honeycomb_mr2.R.id.widget_75_degrees);
        orientationWidget[6] = (ImageView) findViewById(org.ros.android.android_honeycomb_mr2.R.id.widget_90_degrees);
        orientationWidget[7] = (ImageView) findViewById(org.ros.android.android_honeycomb_mr2.R.id.widget_105_degrees);
        orientationWidget[8] = (ImageView) findViewById(org.ros.android.android_honeycomb_mr2.R.id.widget_120_degrees);
        orientationWidget[9] = (ImageView) findViewById(org.ros.android.android_honeycomb_mr2.R.id.widget_135_degrees);
        orientationWidget[10] = (ImageView) findViewById(org.ros.android.android_honeycomb_mr2.R.id.widget_150_degrees);
        orientationWidget[11] = (ImageView) findViewById(org.ros.android.android_honeycomb_mr2.R.id.widget_165_degrees);
        orientationWidget[12] = (ImageView) findViewById(org.ros.android.android_honeycomb_mr2.R.id.widget_180_degrees);
        orientationWidget[13] = (ImageView) findViewById(org.ros.android.android_honeycomb_mr2.R.id.widget_195_degrees);
        orientationWidget[14] = (ImageView) findViewById(org.ros.android.android_honeycomb_mr2.R.id.widget_210_degrees);
        orientationWidget[15] = (ImageView) findViewById(org.ros.android.android_honeycomb_mr2.R.id.widget_225_degrees);
        orientationWidget[16] = (ImageView) findViewById(org.ros.android.android_honeycomb_mr2.R.id.widget_240_degrees);
        orientationWidget[17] = (ImageView) findViewById(org.ros.android.android_honeycomb_mr2.R.id.widget_255_degrees);
        orientationWidget[18] = (ImageView) findViewById(org.ros.android.android_honeycomb_mr2.R.id.widget_270_degrees);
        orientationWidget[19] = (ImageView) findViewById(org.ros.android.android_honeycomb_mr2.R.id.widget_285_degrees);
        orientationWidget[20] = (ImageView) findViewById(org.ros.android.android_honeycomb_mr2.R.id.widget_300_degrees);
        orientationWidget[21] = (ImageView) findViewById(org.ros.android.android_honeycomb_mr2.R.id.widget_315_degrees);
        orientationWidget[22] = (ImageView) findViewById(org.ros.android.android_honeycomb_mr2.R.id.widget_330_degrees);
        orientationWidget[23] = (ImageView) findViewById(org.ros.android.android_honeycomb_mr2.R.id.widget_345_degrees);
        ...
        currentRotationRange = (ImageView) findViewById(org.ros.android.android_honeycomb_mr2.R.id.top_angle_slice);
        previousRotationRange = (ImageView) findViewById(org.ros.android.android_honeycomb_mr2.R.id.mid_angle_slice);
        // Hide the slices/arcs used during the turn-in-place mode.
        currentRotationRange.setAlpha(0.0f);
        previousRotationRange.setAlpha(0.0f);
        lastVelocityDivet = (ImageView) findViewById(org.ros.android.android_honeycomb_mr2.R.id.previous_velocity_divet);
    ...
    private void publishVelocity(double linearVelocityX, double linearVelocityY,
        ...
        currentVelocityCommand.getTwist().getLinear().setX(linearVelocityX);
        currentVelocityCommand.getTwist().getLinear().setY(-linearVelocityY);
        currentVelocityCommand.getTwist().getLinear().setZ(0);
        currentVelocityCommand.getTwist().getAngular().setX(0);
        currentVelocityCommand.getTwist().getAngular().setY(0);
        currentVelocityCommand.getTwist().getAngular().setZ(-angularVelocityZ);
        currentVelocityCommand.getHeader().setFrameId("joystick_teleop");
//        currentVelocityCommand.getHeader().setSeq(seqNumber++);
        //currentVelocityCommand.getHeader().setStamp(Time.fromNano());
    ...
    public void onStart(final ConnectedNode connectedNode) {
        publisher = connectedNode.newPublisher(topicName, TwistStamped._TYPE);
        currentVelocityCommand = publisher.newMessage();
        deadman_publisher = connectedNode.newPublisher("~deadman", Bool._TYPE);
        deadmanSignal = deadman_publisher.newMessage();
        ...
        publisherTimer.schedule(new TimerTask() {
            ...
            public void run() {
                if (publishVelocity) {
                    deadman_publisher.publish(deadmanSignal);
                    currentVelocityCommand.getHeader().setStamp(connectedNode.getCurrentTime());
                    currentVelocityCommand.getHeader().setSeq(seqNumber++);
                    publisher.publish(currentVelocityCommand);
                }
            }
